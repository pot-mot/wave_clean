...
export const MindMapDataResourceType_CONSTANTS = ['image'] as const;
...
export const validateMindMapDataResource = createSchemaValidator<MindMapDataResource>(
    MindMapDataResource_JsonSchema,
);
