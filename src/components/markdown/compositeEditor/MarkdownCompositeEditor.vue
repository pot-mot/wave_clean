...
<template>
    <div class="markdown-composite-editor">
        <Teleport
            :to="fullScreenTeleportTarget"
            :disabled="!isFullScreen"
        >
            <div
                class="markdown-composite-editor-wrapper"
            ...
            >
                ...
                >
                    ...
                    <Teleport
                        defer
                        :disabled="previewType === 'edit-only'"
                        :to="`#${editorPaneId}`"
                    >
                        <MarkdownEditor
                    ...
                    <Teleport
                        defer
                        :disabled="previewType === 'preview-only'"
                        :to="`#${previewPaneId}`"
                    >
                        <MarkdownPreview
