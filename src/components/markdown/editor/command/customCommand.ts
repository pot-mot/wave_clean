...
const checkSelection = (args: any): args is ISelection => {
    return !!(
        args.selectionStartLineNumber &&
        args.selectionStartColumn &&
        args.positionLineNumber &&
        args.positionColumn
    );
};
...
export const registerCustomCommands = () => {
    ...
    editor.registerCommand(COMMAND_setPosition, (_, ...args: any[]) => {
    ...
    editor.registerCommand(COMMAND_setSelection, (_, ...args: any[]) => {
    ...
    editor.registerCommand(COMMAND_removeRange, (_, ...args: any[]) => {
