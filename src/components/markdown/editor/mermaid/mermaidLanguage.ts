...
const mermaidLanguage: IMonarchLanguage = {
...
export const registerMermaidLanguage = () => {
    ...
    editor.defineTheme('mermaid-dark', {
        base: 'vs-dark',
        inherit: true,
        colors: {},
        rules: [
    ...
    languages.registerCompletionItemProvider('mermaid', mermaidCompletionProvider);
